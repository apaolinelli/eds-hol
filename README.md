...
## Environments
- Preview: https://main--eds-hol--apaolinelli.hlx.page/
- Live: https://main--eds-hol--apaolinelli.hlx.live/
...
1. Open the `eds-hol` directory in your favorite IDE and start coding :)
